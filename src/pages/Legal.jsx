    ...
    sections: [
      {
        ...
        body: "BidSmith provides a high-performance workbench for federal capture management. By using the platform, you agree to utilize the services for lawful proposal development and analysis only.",
      },
      {
        id: "subscription",
        heading: "Subscription & Licensing",
        body: "Access to ARIS and associated workbench tools is granted via tiered subscription. Free tier provides 3 audits per month. Paid tiers (Starter, Standard, Enterprise) are billed monthly or annually. Subscriptions auto-renew unless cancelled. Pilot programs are governed by specific 30-day non-persistent execution terms. You may cancel your subscription at any time from your account dashboard; access continues until the end of the current billing period.",
      },
      {
        id: "acceptable-use",
        heading: "Acceptable Use",
        body: "You may not use ARIS to process classified government information, to reverse-engineer competitors' proposals obtained without authorization, to generate fraudulent representations or certifications, or for any purpose that violates applicable law including the False Claims Act. Automated scraping of the platform or API abuse that exceeds published rate limits is prohibited. We reserve the right to suspend accounts that violate these terms.",
      },
      {
        id: "intellectual-property",
        heading: "Intellectual Property",
        body: "The ARIS platform, its underlying algorithms, compliance engine, and all associated software are proprietary to BidSmith and protected by copyright and trade secret law. You retain full ownership of all content you input into the platform. The audit outputs, compliance matrices, and briefings generated by ARIS are licensed to you for your internal business use. You may not resell, sublicense, or publicly redistribute ARIS-generated outputs as a standalone product.",
      },
      {
        id: "liability",
