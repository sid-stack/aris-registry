...
const PAGE_META = {
  ...
  dashboard:    { title: "BidSmith Command Center | RFP & government bid workspace", description: "Your BidSmith Command Center. Paste a SAM.gov URL or upload a PDF — structured read, risk flags, and bid/no-bid rationale in about 90 seconds for typical solicitations.", path: "/dashboard" },
